...
src_path = "/data/hanxiao36/projects/RayRewardServer/questions_results_with_scores_and_penalty.json"
dst_path = "/data/hanxiao36/projects/RayRewardServer/questions_results_with_scores_and_penalty_qwen_question.json"
...
penalty = cluster_share_per_problem(questions, distance_threshold=0.15, linkage="average", diagnostics=True)

for i, item in enumerate(data):
    item["qwen_question_penalty"] = penalty[i]
