...
def generate_results(data: List[Dict]) -> List[Dict]:
    ...
    handler_name = os.getenv("REWARD_HANDLER_NAME", "questioner")
...
src_path = "/data/hanxiao36/projects/visplay_questioner_demo/generate_questions.json"
dst_path = "/data/hanxiao36/projects/visplay_questioner_demo/generate_questions_with_answers.json"
